...
export const shopify = _createShopifyApp();
export const cookieStorage = _createCookieStorage();

// Implementation

function _createShopifyApp() {
  return shopifyApp({
    sessionStorage: _createSessionStorage(),
    api: {
...
function _createSessionStorage() {
  // Lazy init: getFirestore() called at runtime, not import time
  // Firebase must be initialized before accessing Firestore
  let collection;
