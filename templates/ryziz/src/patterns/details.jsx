export const metadata = {
  id: 'details',
  title: 'Details',
  description: 'View, create and edit resource objects with form fields and supporting information',
  category: 'pattern'
};
  ...
  return (
    <>
      ...
      <s-section>
        ...
        <s-paragraph>
          The details page allows merchants to view, create and edit objects. Use the left column to provide editable
          fields, and the right column for supporting information such as status, metadata, and summaries.
        </s-paragraph>
      </s-section>

      {/* Demo section with form */}
      <s-section>
        {/* Form with auto save bar when there are unsaved changes */}
        <form data-save-bar onSubmit={handleSubmit} onReset={handleReset}>
          <s-page heading="Resource Name">
            {/* Breadcrumb navigation */}
            <s-link slot="breadcrumb-actions" href="javascript:void(0)">
              Resources
            </s-link>
