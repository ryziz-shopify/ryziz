...
export const metadata = {
  id: 'homepage',
  title: 'Homepage (Full Layout)',
  description: 'Complete homepage with banner, setup guide, metrics, templates, news, and featured apps sections',
...
export default function DemoHomepage() {
  ...
  return (
    <s-page>
      ...
      <s-button slot="secondary-actions">Import resource</s-button>
      ...
      {visible.banner && (
        ...
        >
          3 of 5 products created.{' '}
          <s-link href="javascript:void(0)">Upgrade to Premium Plan</s-link> to create unlimited
          products.
        </s-banner>
      )}
          ...
          <s-grid gap="small">
            ...
            >
              ...
              <s-box>
                ...
                >
                  <s-checkbox
                    label="Upload an image for your product"
                    onInput={(e) =>
                    ...
                    >
                      <s-grid gap="small-200">
                        <s-paragraph>
                          ...
                          used to create your product. For best results, use
              ...
              <s-box>
                ...
                >
                  <s-checkbox
                    label="Choose a product template"
                    onInput={(e) =>
                      setProgress(e.currentTarget.checked ? progress + 1 : progress - 1)
                    }
                  ></s-checkbox>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <s-grid gap="small-200">
                        <s-paragraph>
                          Select a template for your product - choose between
                          basic (starter), standard (intermediate), or
                          advanced (professional) layouts.
                        </s-paragraph>
                        <s-stack direction="inline" gap="small-200">
              ...
              <s-box>
                ...
                >
                  <s-checkbox
                    label="Customize product settings"
                    onInput={(e) =>
                      setProgress(e.currentTarget.checked ? progress + 1 : progress - 1)
                    }
                  ></s-checkbox>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <s-grid gap="small-200">
                        <s-paragraph>
                          Make your product unique by customizing the display
                          settings. Choose from classic, modern, or
                          themed presentation styles.
                        </s-paragraph>
                        <s-stack direction="inline" gap="small-200">
      ...
      {visible.calloutCard && (
        <s-section>
          ...
          >
            ...
            >
              <s-grid gap="small-200">
                <s-heading>Ready to create your custom product?</s-heading>
                <s-paragraph>
      ...
      {/* === */}
      <s-section>
        <s-heading>Product Templates</s-heading>
        <s-grid
        ...
        >
          ...
          <s-box border="base" borderRadius="base" overflow="hidden">
            <s-clickable
              href="javascript:void(0)"
              accessibilityLabel="Basic template"
            >
              <s-image
                aspectRatio="1/1"
                objectFit="cover"
            ...
            >
              ...
              <s-button
                href="javascript:void(0)"
                accessibilityLabel="View basic template"
              >
                View
              </s-button>
            </s-grid>
          ...
          >
            <s-clickable
              href="javascript:void(0)"
              accessibilityLabel="Standard template"
            >
              <s-image
                aspectRatio="1/1"
                objectFit="cover"
            ...
            <s-grid
              ...
              alignItems="center"
            >
              <s-heading>Standard</s-heading>
              <s-button
                href="javascript:void(0)"
                accessibilityLabel="View standard template"
              >
                View
              </s-button>
            </s-grid>
          ...
          >
            <s-clickable
              href="javascript:void(0)"
              accessibilityLabel="Advanced template"
            >
              <s-image
                aspectRatio="1/1"
                objectFit="cover"
                alt="Advanced template"
            ...
            >
              ...
              <s-button
                href="javascript:void(0)"
                accessibilityLabel="View advanced template"
              >
                View
              </s-button>
            </s-grid>
        ...
        >
          <s-link href="javascript:void(0)">See all product templates</s-link>
        </s-stack>
      </s-section>
      ...
      <s-section>
        ...
        >
          ...
          >
            ...
            <s-link href="javascript:void(0)">
              <s-heading>New display options and themes added</s-heading>
            </s-link>
            <s-paragraph>
              We've added 5 new display options and 3 seasonal themes to
              help you create more engaging and unique products for your
              customers.
            </s-paragraph>
          </s-grid>
          {/* News item 2 */}
          ...
          >
            ...
            <s-link href="javascript:void(0)">
              <s-heading>Product customization features</s-heading>
            </s-link>
            <s-paragraph>
              Now you can fine-tune the appearance of your products with new
              layout controls, highlighting options, and display
              settings.
            </s-paragraph>
          </s-grid>
        </s-grid>
        <s-stack
          ...
          paddingBlockStart="base"
        >
          <s-link href="javascript:void(0)">See all news items</s-link>
        </s-stack>
      </s-section>
